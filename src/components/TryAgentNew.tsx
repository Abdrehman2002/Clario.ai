...
export function TryAgentNew() {
  ...
  return (
    <section className="py-20 pb-32 bg-gradient-to-b from-black via-[#0A0510] to-black relative">
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10">
        <motion.div
          ...
          className="bg-black/40 backdrop-blur-xl rounded-[32px] border border-white/10 shadow-2xl p-8 md:p-12"
        ...
        >
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1 w-full max-w-md space-y-6 relative">
              {/* Dropdown */}
              <div className="relative" ref={dropdownRef}>
                <motion.button
                  ...
                  className={cn(
                    "w-full px-6 py-4 rounded-2xl border-2 transition-all duration-300 text-left flex items-center justify-between",
                    ...
                    >
                      {AGENTS.map((agent, index) => (
                        <motion.button
                          ...
                          className={cn(
                            "w-full px-6 py-4 text-left transition-all duration-200 flex items-center justify-between group",
              ...
              {callStatus === "connected" ? (
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={endCall}
                  className="w-full px-8 py-4 rounded-2xl text-lg font-bold transition-all duration-300 flex items-center justify-center gap-3"
                  style={{
                ...
                <motion.button
                  ...
                  className={cn(
                    "w-full px-8 py-4 rounded-2xl text-lg font-bold transition-all duration-300 flex items-center justify-center gap-3",
