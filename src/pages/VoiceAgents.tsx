...
const VoiceAgents = () => {
  ...
  const features = [
    { icon: Brain, title: "Natural Conversations", desc: "Advanced NLP for human-like interactions", color: "#0066FF" },
    { icon: Clock, title: "24/7 Availability", desc: "Always ready to assist your customers", color: "#25D366" },
    { icon: Users, title: "Multi-language Support", desc: "Communicate in 50+ languages", color: "#FF6B6B" },
    { icon: Shield, title: "Secure & Compliant", desc: "Enterprise-grade security standards", color: "#9C27B0" },
    { icon: TrendingUp, title: "Scalable Performance", desc: "Handle thousands of calls simultaneously", color: "#FF9800" },
    { icon: Zap, title: "Instant Response", desc: "Real-time processing and responses", color: "#4CAF50" }
  ];

  const useCases = [
    { icon: Phone, title: "Customer Support", desc: "Handle inquiries and resolve issues", color: "#0066FF", gradient: "from-[#0066FF] to-[#0033FF]" },
    { icon: MessageSquare, title: "Sales Calls", desc: "Qualify leads and close deals", color: "#25D366", gradient: "from-[#25D366] to-[#128C7E]" },
    { icon: Headphones, title: "Appointment Booking", desc: "Schedule and manage appointments", color: "#FF6B6B", gradient: "from-[#FF6B6B] to-[#FF5252]" },
    { icon: Bot, title: "Order Processing", desc: "Process orders and confirmations", color: "#9C27B0", gradient: "from-[#9C27B0] to-[#7B1FA2]" }
  ];

  const testimonials = [
    { name: "Sarah Chen", role: "Customer Success Manager", company: "TechFlow", rating: 5, quote: "Our support calls are now handled 60% faster with AI voice agents.", avatar: "SC" },
    { name: "Mike Johnson", role: "Sales Director", company: "SalesPro", rating: 5, quote: "The AI agent increased our lead qualification rate by 40%.", avatar: "MJ" }
  ];
    ...
    <div className="min-h-screen bg-[#FFFFFF]">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <motion.div
            className="absolute top-20 left-20 w-96 h-96 bg-gradient-to-r from-[#0066FF]/10 to-[#0033FF]/10 rounded-full blur-3xl"
            variants={floatingVariants}
            animate="animate"
          />
          <motion.div
            className="absolute bottom-20 right-20 w-64 h-64 bg-gradient-to-r from-[#B8C2FF]/15 to-[#CCE0FF]/15 rounded-full blur-2xl"
            variants={floatingVariants}
            animate="animate"
            style={{ animationDelay: "1s" }}
          />
          <motion.div
            className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-32 h-32 bg-gradient-to-r from-[#0066FF]/5 to-[#25D366]/5 rounded-full blur-xl"
            variants={floatingVariants}
            animate="animate"
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          >
            <motion.div variants={itemVariants} className="mb-8">
              <motion.div
                className="inline-flex items-center space-x-3 bg-gradient-to-r from-[#0066FF]/10 to-[#25D366]/10 border border-[#0066FF]/20 rounded-full px-6 py-3 mb-6"
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.6 }}
              >
                <Sparkles className="w-5 h-5 text-[#0066FF]" />
                <span className="text-lg text-[#0066FF] font-semibold">AI Voice Agents</span>
            ...
            >
              Transform your customer interactions with intelligent voice agents that understand, respond, and assist 24/7 with human-like conversations.
            </motion.p>
            ...
            >
              ...
              >
                <Button 
                  className="bg-gradient-to-r from-[#0066FF] to-[#25D366] hover:from-[#0052CC] hover:to-[#128C7E] text-white px-10 py-5 text-xl font-bold rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-300 group relative overflow-hidden"
                  size="lg"
                >
              ...
              >
                <Button 
                  variant="outline"
                  className="border-3 border-[#0066FF]/30 hover:border-[#0066FF] text-[#1A1A1A] hover:text-[#0066FF] px-10 py-5 text-xl font-bold rounded-2xl bg-white/90 backdrop-blur-sm hover:bg-white transition-all duration-300 group relative overflow-hidden"
                  size="lg"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                ...
                >
                  ...
                  >
                    <div className="w-20 h-20 bg-gradient-to-r from-[#0066FF] to-[#25D366] rounded-3xl flex items-center justify-center shadow-xl relative overflow-hidden">
                      <div className="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
              {testimonials.map((testimonial, index) => (
                ...
                >
                  {/* Quote Icon */}
                  <motion.div 
                    className="absolute top-8 right-8 text-[#B8C2FF]"
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="w-16 h-16 bg-gradient-to-r from-[#0066FF] to-[#25D366] rounded-2xl flex items-center justify-center shadow-lg">
      ...
      <section className="py-24 bg-[#FFFFFF] relative overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          >
            <motion.div 
              className="bg-gradient-to-r from-[#0066FF] via-[#25D366] to-[#0066FF] rounded-3xl p-16 lg:p-20 text-white relative overflow-hidden"
              variants={itemVariants}
            >
              {/* Background Pattern */}
              ...
              <motion.p 
                ...
                viewport={{ once: true }}
              >
                Join thousands of businesses already using AI voice agents to enhance their customer interactions and drive growth.
              </motion.p>
              ...
              >
                ...
                >
                  <Button 
                    className="bg-white text-[#0066FF] hover:bg-gray-100 px-12 py-6 text-xl font-bold rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-300 group relative overflow-hidden"
                    size="lg"
                  >
                    <div className="absolute inset-0 bg-gradient-to-r from-[#0066FF]/5 to-[#25D366]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    <Bot className="w-6 h-6 mr-3 group-hover:rotate-12 transition-transform duration-300 relative z-10" />
                    Start Free Trial
                ...
                >
                  <Button 
                    variant="outline"
                    className="border-3 border-white/30 text-white hover:bg-white hover:text-[#0066FF] px-12 py-6 text-xl font-bold rounded-2xl backdrop-blur-sm transition-all duration-300 group relative overflow-hidden"
                    size="lg"
                  >
              ...
              >
                ...
                <Button 
                  variant="outline"
                  className="border-2 border-white/50 text-white hover:bg-white hover:text-[#0066FF] px-8 py-4 text-lg font-semibold rounded-xl backdrop-blur-sm transition-all duration-300 group"
                >
