...
const AIChatbots = () => {
  ...
  const testimonials = [
    { name: "Jennifer Park", role: "Customer Success Manager", company: "ChatFlow", rating: 5, quote: "Our AI chatbot handles 70% of customer inquiries automatically, reducing response time from hours to seconds.", avatar: "JP" },
    { name: "Marcus Rodriguez", role: "E-commerce Director", company: "ShopSmart", rating: 5, quote: "The chatbot increased our conversion rate by 35% and improved customer satisfaction significantly.", avatar: "MR" }
  ];
    ...
    <div className="min-h-screen bg-[#FFFFFF]">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          />
          <motion.div
            className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-32 h-32 bg-gradient-to-r from-[#8B5CF6]/5 to-[#06B6D4]/5 rounded-full blur-xl"
            variants={floatingVariants}
            animate="animate"
          ...
          >
            <motion.div variants={itemVariants} className="mb-8">
              ...
              >
                ...
                <span className="text-lg text-[#8B5CF6] font-semibold">AI Chatbots</span>
            ...
            >
              ...
              >
                <Button 
                  className="bg-gradient-to-r from-[#8B5CF6] to-[#06B6D4] hover:from-[#7C3AED] hover:to-[#0891B2] text-white px-10 py-5 text-xl font-bold rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-300 group relative overflow-hidden"
                  size="lg"
                >
              ...
              >
                <Button 
                  variant="outline"
                  className="border-3 border-[#8B5CF6]/30 hover:border-[#8B5CF6] text-[#1A1A1A] hover:text-[#8B5CF6] px-10 py-5 text-xl font-bold rounded-2xl bg-white/90 backdrop-blur-sm hover:bg-white transition-all duration-300 group relative overflow-hidden"
                  size="lg"
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-[#8B5CF6]/5 to-[#06B6D4]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                ...
                >
                  {/* Animated Background */}
                  <div className="absolute inset-0 bg-gradient-to-br from-[#C4B5FD]/5 to-[#A5F3FC]/3 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-3xl"></div>
                  ...
                  >
                    <div className="w-20 h-20 bg-gradient-to-r from-[#8B5CF6] to-[#06B6D4] rounded-3xl flex items-center justify-center shadow-xl relative overflow-hidden">
                      <div className="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  ...
                  {/* Hover Glow */}
                  <div className="absolute inset-0 bg-gradient-to-r from-[#8B5CF6]/5 to-[#06B6D4]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-3xl"></div>
                </motion.div>
              ))}
            </div>
          </motion.div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
              {testimonials.map((testimonial, index) => (
                ...
                >
                  {/* Quote Icon */}
                  <motion.div 
                    className="absolute top-8 right-8 text-[#C4B5FD]"
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="w-16 h-16 bg-gradient-to-r from-[#8B5CF6] to-[#06B6D4] rounded-2xl flex items-center justify-center shadow-lg">
      ...
      <section className="py-24 bg-[#FFFFFF] relative overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          >
            <motion.div 
              className="bg-gradient-to-r from-[#8B5CF6] via-[#06B6D4] to-[#8B5CF6] rounded-3xl p-16 lg:p-20 text-white relative overflow-hidden"
              variants={itemVariants}
            >
              {/* Background Pattern */}
              ...
              >
                ...
                >
                  <Button 
                    className="bg-white text-[#8B5CF6] hover:bg-gray-100 px-12 py-6 text-xl font-bold rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-300 group relative overflow-hidden"
                    size="lg"
                  >
                    <div className="absolute inset-0 bg-gradient-to-r from-[#8B5CF6]/5 to-[#06B6D4]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                ...
                >
                  <Button 
                    variant="outline"
                    className="border-3 border-white/30 text-white hover:bg-white hover:text-[#8B5CF6] px-12 py-6 text-xl font-bold rounded-2xl backdrop-blur-sm transition-all duration-300 group relative overflow-hidden"
                    size="lg"
                  >
              ...
              >
                ...
                <Button 
                  variant="outline"
                  className="border-2 border-white/50 text-white hover:bg-white hover:text-[#8B5CF6] px-8 py-4 text-lg font-semibold rounded-xl backdrop-blur-sm transition-all duration-300 group"
                >
