      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 relative overflow-visible" style={{ zIndex: 60 }}>
        ...
        <div className="text-center mb-16 md:mb-20 px-4 relative">
          ...
          <div className="relative">
            ...
            <h2 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-white mb-4 sm:mb-5 md:mb-6 lg:mb-8 px-2 sm:px-4"
                style={{
                  lineHeight: '1.1',
