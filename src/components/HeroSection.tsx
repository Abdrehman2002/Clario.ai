...
const HeroSection = () => {
  ...
  if (!isMobile) {
    return (
      <section className="relative min-h-[100dvh] max-h-[100dvh] h-[100dvh] flex items-center justify-center overflow-hidden z-[1]" style={{ boxSizing: 'border-box', maxWidth: '100vw', width: '100%' }}>
        ...
        <div className="absolute inset-0 w-full h-full z-[15] spline-container pointer-events-auto" style={{ maxWidth: '100vw', width: '100%', overflow: 'hidden' }}>
          ...
          <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: '60px', background: '#000000', zIndex: 50 }} />
        </div>
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-b from-black via-[#0A0510] to-black overflow-hidden" style={{ boxSizing: 'border-box' }}>
      ...
      <div className="max-w-[480px] mx-auto px-5 relative z-[1] min-h-screen flex items-center pt-20 pb-8" style={{ boxSizing: 'border-box' }}>
